...
function App() {
  return (
    <div className="App">
        ...
        <BoxBar top={50}  left={64}  background={false} porcent={70}  tank={70} product2={'40065007'} plant='H3 Plant' barID={5}/>
        <BoxBar top={18}  left={58}  background={false} porcent={90}  tank={80} product2={'40980002'} plant='H2 Plant' barID={6}/>
