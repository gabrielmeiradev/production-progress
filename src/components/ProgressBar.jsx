...
const ProgressBar = ({porcent}) => {
    ...
    <div className="wrapper" >
        <svg height={110} width={310} xmlns="http://www.w3.org/2000/svg" >
            ...
            d="M192.464 3785.826c76.583-53.15 171.3-81.73 255.997-79.045 100.767 3.196 190.947 47.425 269.572 102.314 0 0 27.777 4.752 41.763 6.411 15.867 1.883 47.767 4.015 47.767 4.015l150.536-5.793 631.534 2.649 76.867 79.205 513.718-1.918 86.076 87.411 1.878 234.132-86.087 87.174-164.265 1.133-64.47 60.01-1134.235-2.047s-83.763 5.292-101.563 7.022c-22.345 12.683-35.424 28.458-52.424 39.55-44.08 28.757-82.248 47.539-136.494 59.382-117.388 25.628-272.918 2.516-378.906-105.693L88.984 4275.1l-26.31-54.942-16.771-59.965-2.375-62.605-1.786-35.002 6.788-35.233 16.795-60.44 3.977-28.8 21.213-37.77 16.159-30.515 22.847-22.591 25.462-31.818z"
            ...
            <g
            clipPath="url(#a)"
            transform="matrix(.13333 0 0 -.13333 -397.132 579.588)"
            >
            <image
            ...
            <linearGradient id="green-3" x1="0%" y1="50%" x2="100%" y2="50%">
                <stop
                offset="0%"
                style={{
                    stopColor: "#005a39",
            ...
            style={{
                //yellow
                fill: porcent>96?'url(#green-3)':"#0f4c4d",
                fillOpacity: 1,
                fillRule: "nonzero",
                stroke: "none",
            }}
            ...
            />
            {/* donut */}
            <linearGradient id="red-1" x1="0%" y1="50%" x2="100%" y2="50%">
                <stop
                offset="0%"
                style={{
                    stopColor: "#be0000",
            ...
            style={{
                // red
                fill: porcent>0?'url(#red-1':'#0f4c4d',
                fillOpacity: 1,
                fillRule: "nonzero",
                stroke: "none",
            }}
            ...
            transform="matrix(.13333 0 0 -.13333 .752 600.752)"
            />
            <linearGradient id="red-3" x1="0%" y1="50%" x2="100%" y2="50%">
                <stop
                offset="0%"
                style={{
                    stopColor: "#f74444",
            ...
            style={{
                ...
                fill: porcent>16?'url(#red-3)':'#0f4c4d',
                fillOpacity: 1,
                fillRule: "nonzero",
                stroke: "none",
            }}
            ...
            transform="matrix(.13333 0 0 -.13333 .752 600.752)"
            />
            <linearGradient id="yellow-3" x1="0%" y1="50%" x2="100%" y2="50%">
                <stop
                offset="0%"
                style={{
                    stopColor: "#c3ff3b",
            ...
            style={{
                // green
                // fill:'url(#yellow-3)',
                 fill:porcent>62?'url(#yellow-3)':'#0f4c4d',
            ...
            transform="matrix(.13333 0 0 -.13333 .752 600.752)"
            />
            <linearGradient id="yellow-4" x1="0%" y1="50%" x2="100%" y2="50%">
                <stop
                offset="0%"
                style={{
                    stopColor: "#3ee655",
            ...
            style={{
                //pink
                fill: porcent>72?'url(#yellow-4)':'#0f4c4d',
                fillOpacity: 1,
                fillRule: "nonzero",
                stroke: "none",
            }}
            ...
            transform="matrix(.13333 0 0 -.13333 .752 600.752)"
            />
           <linearGradient id="green-1" x1="0%" y1="50%" x2="100%" y2="50%">
                <stop
                offset="0%"
                style={{
                    stopColor: "#0affa5",
            ...
            style={{
                //brown
                fill: porcent>80?'url(#green-1)':'#0f4c4d',
                fillOpacity: 1,
                fillRule: "nonzero",
                stroke: "none",
            }}
            ...
            transform="matrix(.13333 0 0 -.13333 .752 600.752)"
            />
            <linearGradient id="green-2" x1="0%" y1="50%" x2="100%" y2="50%">
                <stop
                offset="0%"
                style={{
                    stopColor: "#00b786",
            ...
            style={{
                //purple
                fill: porcent>88?'url(#green-2)':'#0f4c4d',
                fillOpacity: 1,
                fillRule: "nonzero",
                stroke: "none",
            }}
            ...
            transform="matrix(.13333 0 0 -.13333 .752 600.752)"
            />
            <linearGradient id="red-2" x1="0%" y1="50%" x2="100%" y2="50%">
                <stop
                offset="0%"
                style={{
                    stopColor: "red",
            ...
            style={{
                //orange
                fill: porcent>8?'url(#red-2)':'#0f4c4d',
                fillOpacity: 1,
                fillRule: "nonzero",
                stroke: "none",
            }}
            ...
            transform="matrix(.13333 0 0 -.13333 .752 600.752)"
            />
            <linearGradient id="yellow-2" x1="0%" y1="50%" x2="100%" y2="50%">
                <stop
                offset="0%"
                style={{
                    stopColor: "#dce91f",
            ...
            <linearGradient id="yellow-1" x1="0%" y1="50%" x2="100%" y2="50%">
                <stop
                offset="0%"
                style={{
                    stopColor: "#dce91f",
            ...
            style={{
                ...
                //  fill: "url(#yellow-2)",
                // fill: "url(#yellow-1)",
                fill: porcent>48&&porcent<=56?'url(#yellow-1)':
                porcent>56?'url(#yellow-2)':'#0f4c4d',
                fillOpacity: 1,
                fillRule: "nonzero",
                stroke: "none",
            }}
            ...
            <radialGradient id="0" gradientTransform="translate(-1 -0.5) scale(2, 2)">
                ...
                <stop offset="62.5%" stopColor="rgba(215, 61, 78, 0.75)"/>
                <stop offset="75%" stopColor="rgba(202, 59, 87, 0.5)"/>
                <stop offset="100%" stopColor="rgba(177, 56, 94, 0)"/>
            </radialGradient>
            <linearGradient id="orange-1" x1="0%" y1="50%" x2="100%" y2="50%">
                <stop
                offset="0%"
                style={{
                    stopColor: "#e53e3e",
            ...
            <linearGradient id="orange-2" x1="0%" y1="50%" x2="100%" y2="50%">
                <stop
                offset="0%"
                style={{
                    stopColor: "#e53e3e",
            ...
            <linearGradient id="orange-3" x1="0%" y1="50%" x2="100%" y2="50%">
                <stop
                offset="0%"
                style={{
                    stopColor: "#e53e3e",
            ...
            style={{
                //los 4
                fill: porcent>24&&porcent<=32?'url(#orange-1)':
                      porcent>32&&porcent<=40?'url(#orange-2)':
                      porcent>40?'url(#orange-3)':'#0f4c4d',
                fillOpacity: 1,
                fillRule: "nonzero",
                stroke: "none",
            }}
